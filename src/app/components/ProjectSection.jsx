...
const projectsData = [
  ...
  },
  {
    id: 3,
    title: "CoinSwitch",
    description: "A dynamic cryptocurrency tracking app leveraging React and multiple APIs for real-time data",
  ...
  },
  {
    id: 5,
    title: "NewsApp",
    description: "News aggregation app using React and News APIs to deliver real-time news updates.",
